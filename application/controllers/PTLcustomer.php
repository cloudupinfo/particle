...
class PTLcustomer extends CI_Controller {
    ...
    public function paid_customer() {
     ...
     public function CheckPaidCustomerList(){
      ...
      public function customer_ledger_report() {
        $config["base_url"] = base_url('PTLcustomer/customer_ledger_report/');
  ...
  $createdate=date('Y-m-d H:i:s');
    ...
    $customer_coa = [
            ...
            if (isset($_POST['add-customer'])) {
                redirect(base_url('PTLcustomer/manage_customer'));
                exit;
            } elseif (isset($_POST['add-customer-another'])) {
                redirect(base_url('PTLcustomer'));
                exit;
            }
    ...
    $customer_headcode = $coainfo->HeadCode;
      ...
      'IsAppove'       =>  1
                   ...
                   $this->db->insert('acc_transaction',$cc);
                    redirect(base_url('PTLcustomer/customer_advancercpt/'.$transaction_id.'/'.$customer_id));
