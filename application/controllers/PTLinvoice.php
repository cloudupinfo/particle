...
class PTLinvoice extends CI_Controller {
    ...
    public function insert_invoice() {
        ...
        redirect(base_url('PTLinvoice/invoice_inserted_data/'.$invoice_id));
...
// invoice list pdf download
    public function sale_downloadpdf(){
        ...
        redirect("PTLinvoice/manage_invoice");
    }
    ...
    public function invoice_search() {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('PTLinvoice/invoice_search/');
    ...
    public function date_to_date_invoice() {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('PTLinvoice/date_to_date_invoice/');
