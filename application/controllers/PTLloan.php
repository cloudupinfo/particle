...
class PTLloan extends CI_Controller {
    ...
    public function manage_ofln_person() {
        ...
        #pagination starts
        $config["base_url"] = base_url('PTLloan/manage_ofln_person/');
    ...
    public function submit_person1() {
        ...
        if ($result) {
            ...
            redirect(base_url('PTLloan/manage_ofln_person'));
        } else {
   ...
   $bankc = array(
      ...
      'IsAppove'       =>  1
        ...
        $this->db->insert('acc_transaction',$cc);
            ...
            $this->session->set_userdata(array('message' => display('successfully_added')));
            redirect(base_url('PTLloan/add_office_loan'));
        } else {
            $this->session->set_userdata(array('error_message' => display('not_added')));
            redirect(base_url('PTLloan/add_office_loan'));
        }
   ...
   $bankc = array(
      ...
      'IsAppove'       =>  1
        ...
        $this->db->insert('acc_transaction',$cc);
            ...
            $this->session->set_userdata(array('message' => display('successfully_added')));
            redirect(base_url('PTLloan/add_loan_payment'));
        } else {
            $this->session->set_userdata(array('error_message' => display('not_added')));
            redirect(base_url('PTLloan/add_loan_payment'));
        }
