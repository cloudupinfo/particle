...
class PTLreport extends CI_Controller {
  ...
  public function index()
    ...
    public function stock_report_product_wise() {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('PTLreport/stock_report_product_wise/');
...
// date wise product report
    public function stock_date_to_date_product_wise() {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('PTLreport/stock_date_to_date_product_wise/');
    ...
    public function stock_report_supplier_wise() {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('PTLreport/stock_report_supplier_wise');
