...
class PTLretrun_m extends CI_Controller {
...
// supplier return form
    ...
    public function return_invoice() {
        ...
        redirect("PTLretrun_m/invoice_inserted_data/".$invoice_id);
    }
    ...
    public function return_suppliers() {
        ...
        $this->session->set_userdata(array('message' => display('successfully_added')));
         redirect("PTLretrun_m/supplier_inserted_data/".$purchase_id);
    }
    ...
    public function return_list() {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('PTLretrun_m/return_list/');
...
// date between return report list
    ...
    public function supplier_return_list() {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('PTLretrun_m/supplier_return_list/');
...
// wastage return list start
    public function wastage_return_list() {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('PTLretrun_m/wastage_return_list/');
...
// Return delete with invoice id
    public function delete_retutn_invoice($invoice_id = null) {
        ...
        redirect("PTLretrun_m/return_list");
    }
    ...
    public function delete_retutn_purchase($purchase_id = null) {
        ...
        redirect("PTLretrun_m/supplier_return_list");
    }
