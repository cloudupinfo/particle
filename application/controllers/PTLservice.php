...
class PTLservice extends CI_Controller {
       ...
       $data['description'] = $this->input->post('description',true);
        ...
        if ($result == TRUE) {
            $this->session->set_userdata(array('message' => display('successfully_added')));
                ...
                redirect(base_url('PTLservice/manage_service'));
           
        } else {
            $this->session->set_userdata(array('error_message' => display('already_inserted')));
            redirect(base_url('PTLservice'));
        }
    }
...
public function insert_service_invoice(){
        ...
        $this->session->set_userdata(array('message' => display('successfully_added')));
        redirect(base_url('PTLservice/service_invoice_data/'.$invoice_id));
...
// sent pdf copy to customer after invoice
  ...
  //pdf download service invoice details
     public function servicedetails_download($invoice_id = null) {
        ...
        redirect("PTLservice/manage_service");
    }
  ...
  public function service_invoice_update_form($invoic_id) {
        ...
        $config["base_url"] = base_url('PTLservice/manage_service_invoice');
    ...
    public function service_invoic_delete($service_id) {
        ...
        $this->session->set_userdata(array('message' => display('successfully_delete')));
         redirect(base_url('PTLservice/manage_service_invoice'));
    }
