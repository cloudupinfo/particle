...
class PTLsettings extends CI_Controller {
    ...
    public function add_new_bank() {
        ...
        if ($_FILES['signature_pic']['name']) {
            ...
            if (!$this->upload->do_upload('signature_pic')) {
                ...
                redirect(base_url('PTLsettings/index'));
            } else {
        ...
        redirect(base_url('PTLsettings/bank_list'));
        exit;
    ...
    public function submit_person() {
      $person_id = $this->auth->generator(10);
        ...
        if ($result) {
            ...
            $this->session->set_userdata(array('message' => display('successfully_added')));
            redirect(base_url('PTLsettings/manage_person'));
        } else {
    ...
    public function submit_loan() {
        ...
        if ($result) {
            ...
            $this->session->set_userdata(array('message' => display('successfully_added')));
            redirect(base_url('PTLsettings/add_loan'));
        } else {
            $this->session->set_userdata(array('error_message' => display('not_added')));
            redirect(base_url('PTLsettings/add_loan'));
        }
    ...
    public function submit_payment() {
        ...
        if ($result) {
            $this->session->set_userdata(array('message' => display('successfully_added')));
            redirect(base_url('PTLsettings/add_payment'));
        } else {
            $this->session->set_userdata(array('error_message' => display('not_added')));
            redirect(base_url('PTLsettings/add_payment'));
        }
    ...
    public function manage_person() {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('PTLsettings/manage_person/');
    ...
    public function manage_loan() {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('PTLsettings/manage_loan/');
    ...
    public function update_person($person_id) {
        ...
        if ($result) {
            ...
            redirect(base_url('PTLloan/manage1_person'));
        } else {
            $this->session->set_userdata(array('error_message' => display('not_added')));
            redirect(base_url('PTLloan/manage1_person'));
        }
    ...
    public function update_loan($person_id) {
        ...
        if ($result) {
            $this->session->set_userdata(array('message' => display('successfully_updated')));
            redirect(base_url('PTLsettings/manage_loan'));
        } else {
            $this->session->set_userdata(array('error_message' => display('not_added')));
            redirect(base_url('PTLsettings/manage_loan'));
        }
    ...
    public function update_bank($bank_id) {
        ...
        $this->session->set_userdata(array('message' => display('successfully_updated')));
        redirect('PTLsettings/bank_list');
    }
    ...
    public function table_list() {
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('PTLsettings/table_list/');
