...
class PTLsupplier extends CI_Controller {
    ...
    public function insert_supplier() {
        ...
        $supplier_coa = [
            ...
            if (isset($_POST['add-supplier'])) {
                redirect(base_url('PTLsupplier/manage_supplier'));
                exit;
            } elseif (isset($_POST['add-supplier-another'])) {
                redirect(base_url('PTLsupplier'));
                exit;
            }
    ...
    public function supplier_ledger_report() {
        $config["base_url"] = base_url('PTLsupplier/supplier_ledger_report/');
    ...
    public function supplier_sales_details_all() {
        $config["base_url"] = base_url('PTLsupplier/supplier_sales_details_all/');
        ...
        $config["base_url"] = base_url('PTLsupplier/supplier_sales_details_datewise/');
    ...
    $supplier_headcode = $coainfo->HeadCode;
      ...
      'IsAppove'       =>  1
       ...
       $this->db->insert('acc_transaction',$cc);
        redirect(base_url('PTLsupplier/supplier_advancercpt/'.$transaction_id.'/'.$supplier_id));
