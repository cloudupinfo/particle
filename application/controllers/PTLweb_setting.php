...
class PTLweb_setting extends CI_Controller {
    ...
    public function update_setting() {
        ...
        $config['encrypt_name']   = TRUE;
            ...
            if (!$this->upload->do_upload('logo')) {
                ...
                redirect(base_url('PTLweb_setting'));
            } else {
    ...
    public function update_app_setting(){
     ...
     if(!empty($id)){
         ...
         redirect(base_url('PTLweb_setting/app_setting'));          
    }
...
//    ============ its for mail_config_update ============
    public function mail_config_update() {
        ...
        redirect(base_url('PTLweb_setting/mail_setting'));
    }
