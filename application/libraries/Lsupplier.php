...
class Lsupplier {
    ...
    public function supplier_search_item($supplier_id) {
        ...
        if ($suppliers_list) {
            ...
            redirect('PTLsupplier/manage_supplier');
        }
    }
    ...
    public function supplier_ledger($supplier_id, $start, $end) {
        ...
        $data = array(
            ...
            'supplier_ledger'  => 'PTLsupplier/supplier_ledger',
            'supplier'         => $supplier,
            'currency'         => $currency_details[0]['currency'],
            'position'         => $currency_details[0]['currency_position'],
            'links'            => '',
    ...
    public function supplier_sales_details_allm($links, $per_page, $page) {
        ...
        $data = array(
            ...
            'links'           => $links,
            'supplier_ledger' => 'PTLsupplier/supplier_ledger/',
            'supplier_sales_details' => 'PTLsupplier/supplier_sales_details',
            'supplier_sales_summary' => 'PTLsupplier/supplier_sales_summary/',
            'sales_payment_actual'   => 'PTLsupplier/sales_payment_actual/',
            'currency'        => $currency_details[0]['currency'],
            'position'        => $currency_details[0]['currency_position'],
        );
        $sales_report = $CI->parser->parse('supplier/supplier_sales_details', $data, true);
    ...
    public function supplier_sales_summary($supplier_id, $links, $per_page, $page) {
        ...
        $data = array(
            ...
            'sales_info'             => $sales_info,
            'links'                  => $links,
            'supplier_ledger'        => 'PTLsupplier/supplier_ledger/' . $supplier_id,
            'supplier_sales_details' => 'PTLsupplier/supplier_sales_details/' . $supplier_id,
            'supplier_sales_summary' => 'PTLsupplier/supplier_sales_summary/' . $supplier_id,
            'sales_payment_actual'   => 'PTLsupplier/sales_payment_actual/' . $supplier_id,
            'currency'               => $currency_details[0]['currency'],
            'position'               => $currency_details[0]['currency_position'],
        );
