...
// receipt table
    ...
    public function accounts_summary($type) {
        ...
        foreach ($query->result_array() as $result) {
            ...
            if ($no_trans > 0) {
                ...
                $link = base_url() . "PTLaccounts/summary_single/" . $gmdate . "/" . $this->todays_date . "/" . $table;
    ...
    public function accounts_summary_datewise($start, $end, $type) {
        ...
        foreach ($query->result_array() as $result) {
            ...
            if ($no_trans > 0) {
                ...
                $link = base_url() . "PTLaccounts/summary_single/" . $start . "/" . $end . "/" . $table;
                $account_name = "<a href='" . $link . "' >" . $result['account_name'] . "</a>";
    ...
    public function idtracker($id) {
        ...
        if ($afrows == 0) {
            ...
            if ($afrows == 0) {
                ...
                $supplier = "<a href=" . base_url() . "PTLsupplier/supplier_ledger/" . $id . ">" . $account[0]['supplier_name'] . "</a>";
            ...
            $customer = "<a href=" . base_url() . "PTLcustomer/customerledger/" . $id . ">" . $account[0]['customer_name'] . "</a>";
    ...
    public function get_date_wise_closing_report($per_page = null, $page = null, $from_date, $to_date) {
