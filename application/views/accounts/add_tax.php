...
<div class="content-wrapper">
 ...
 <?php if($this->permission1->method('manage_tax','read')->access()){ ?>
                  <a href="<?php echo base_url('PTLaccounts/manage_tax')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('manage_tax')?> </a>
              <?php }?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                   ...
                   <?php echo form_open_multipart('PTLaccounts/tax_entry',array('class' => 'form-vertical','id' => 'tax_entry' ))?>
