...
<a href="<?php echo base_url();?>PTLattendance/single_checkin" class="btn btn-primary"><?php echo display('single_checkin')?></a>
...
<a href="<?php echo base_url();?>PTLattendance/manage_attendance" class="btn btn-primary"><?php echo display('manage_attendance')?></a>
                    </div>
                </div>
                        ...
                        <?php foreach ($att_list as $row): ?>
                            ...
                            <td><?php echo $sl; ?></td>
                                ...
                                <?php if($row['staytime']==''){
                                    $id=$row["att_id"];
                                    ?>
                                   <a href='<?php echo base_url("PTLattendance/checkout/".$id)?>' class='btn btn-success'><i class='fa fa-clock-o' aria-hidden='true'></i> <?php echo display('checkout') ?></a>
                                  <?php  } 
                                    else {
    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <?php echo form_open_multipart('PTLattendance/attendance_bulkupload',array('class' => 'form-vertical', 'id' => 'validate','name' => 'insert_attendance'))?>
                            <div class="col-sm-12">
