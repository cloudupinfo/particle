...
<div class="content-wrapper">
 ...
 <?php if($this->permission1->method('create_category','create')->access()){ ?>
                    <a href="<?php echo base_url('PTLcategory') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_category') ?> </a>
<?php }?>
<?php if($this->permission1->method('create_category','create')->access()){ ?>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                           <a href="<?php echo base_url('PTLcategory/category_downloadpdf')?>" class="btn btn-warning">Pdf</a> 
                        </div>
                    </div>
                            ...
                            <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <center>
                                        ...
                                        <a href="<?php echo base_url() . 'PTLcategory/category_update_form/{category_id}'; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <?php }?>
                                      <?php if($this->permission1->method('manage_category','delete')->access()){ ?>
                                        <a href="<?php echo base_url() . 'PTLcategory/category_delete/{category_id}'; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Want To Delete ?')" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    <?php }?>
                                            <?php echo form_close() ?>
                                    </center>
                                    </td>
      ...
      <div class="modal-body">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <?php echo form_open_multipart('PTLcategory/uploadCsv_category',array('class' => 'form-vertical', 'id' => 'validate','name' => 'insert_category'))?>
                            <div class="col-sm-12">
