...
<div class="content-wrapper">
    ...
    <section class="content">
                                    ...
                                    if ($expense_list) {
                                        foreach ($expense_list as $expense) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo html_escape($expense['amount']);
        ...
        <?php if($this->permission1->method('manage_expense','delete')->access()){ ?>
                                                      <a href="<?php echo base_url("PTLexpense/delete_expense/".$expense['voucher_no']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a>
                                                    <?php }?>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="2"><?php echo display('total')?></td>
                                        <td><?php echo html_escape(number_format($totalam,2))?></td>
                                        <td></td>
                                    </tr>
                                </tfoot>
