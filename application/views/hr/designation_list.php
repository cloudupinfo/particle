    ...
    <section class="content">
        ...
        <div class="row">
         ...
         <?php if($this->permission1->method('manage_designation','update')->access()){ ?>                              
                                        <a href="<?php echo base_url() . 'PTLhrm/designation_update_form/'.$designations['id']; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <?php } ?>
      <?php if($this->permission1->method('manage_designation','delete')->access()){ ?>                                
                                        <a href="<?php echo base_url('PTLhrm/designation_delete/'.$designations["id"]) ?>" class="btn btn-danger btn-sm"  onclick="return confirm('<?php echo display('are_you_sure') ?>')" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    <?php }?>
