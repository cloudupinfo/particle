    ...
    <nav class="navbar navbar-static-top text-center">
        ...
        <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button"> <!-- Sidebar toggle button-->
          ...
          if($this->uri->segment(2) =="pos_invoice" ){
           ...
           ?>
           <a href="<?php echo base_url('PTLinvoice')?>" class="btn btn-success btn-outline"><i class="fa fa-balance-scale"></i> <?php  echo display('invoice') ?></a>
     <?php }?>
...
<?php if($this->permission1->method('add_purchase','create')->access()){ ?>
          <a href="<?php echo base_url('PTLpurchase')?>" class="btn btn-success btn-outline"><i class="ti-shopping-cart"></i> <?php echo display('purchase') ?></a>
 <?php }} ?>

        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                <li class="dropdown notifications-menu">
                    <a href="<?php echo base_url('PTLreport/out_of_stock') ?>" >
...
<aside class="main-sidebar">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            if ($this->uri->segment('1') == ("PTLinvoice")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li  class="treeview <?php
            if ($this->uri->segment('1') == ("PTLinvoice") && $this->uri->segment('2') == ("")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>"><a href="<?php echo base_url('PTLinvoice') ?>"><?php echo display('new_invoice') ?></a></li>
                <?php } ?>
            ...
            ?>"><a href="<?php echo base_url('PTLinvoice/manage_invoice') ?>"><?php echo display('manage_invoice') ?></a></li>
                    <?php } ?>
            ...
            ?>"><a href="<?php echo base_url('PTLinvoice/pos_invoice') ?>"><?php echo display('pos_invoice') ?></a></li>
            <?php } ?>
            ...
            ?>"><a href="<?php echo base_url('PTLinvoice/gui_pos') ?>"><?php echo display('gui_pos') ?></a></li>
                    <?php } ?>
                </ul>
            </li>
             <?php } ?>
            ...
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLcustomer")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLcustomer") && $this->uri->segment('2') == ("")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>"><a href="<?php echo base_url('PTLcustomer') ?>"><?php echo display('add_customer') ?></a></li>
                <?php } ?>
            ...
            ?>"><a href="<?php echo base_url('PTLcustomer/manage_customer') ?>"><?php echo display('manage_customer') ?></a></li>
                     <?php } ?>
            ...
            ?>"><a href="<?php echo base_url('PTLcustomer/customer_ledger_report') ?>"><?php echo display('customer_ledger') ?></a></li>
                     <?php } ?>
            ...
            ?>"><a href="<?php echo base_url('PTLcustomer/credit_customer') ?>"><?php echo display('credit_customer') ?></a></li>
                     <?php } ?> 
            ...
            ?>"><a href="<?php echo base_url('PTLcustomer/paid_customer') ?>"><?php echo display('paid_customer') ?></a></li>
                     <?php } ?> 
            ...
            ?>"><a href="<?php echo base_url('PTLcustomer/customer_advance') ?>"><?php echo display('customer_advance') ?></a></li>
                      <?php } ?>
                </ul>
            </li>
        <?php }?>
            ...
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLproduct") ||$this->uri->segment('1') == ("PTLunit")|| $this->uri->segment('1') == ("PTLcategory")) {
                echo "active";
            } else {
                echo " ";
            }
        ...
        <?php if($this->permission1->method('manage_category','create')->access() || $this->permission1->method('manage_category','read')->access()|| $this->permission1->method('manage_category','update')->access()|| $this->permission1->method('manage_category','delete')->access()){ ?>
                    <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLcategory")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>"><a href="<?php echo base_url('PTLcategory') ?>"><?php echo display('category') ?></a></li>
                <?php } ?>
            <!-- Category menu end -->
                   <!--Unit menu start--> 
       <?php if($this->permission1->method('manage_unit','create')->access() || $this->permission1->method('manage_unit','read')->access() || $this->permission1->method('manage_unit','delete')->access() || $this->permission1->method('manage_unit','update')->access()){ ?>
                    <li class="treeview <?php
            if ($this->uri->segment('1') == "PTLunit") {
                echo "active";
            } else {
                echo " ";
            }
            ?>"><a href="<?php echo base_url('PTLunit'); ?>"><?php echo display('unit'); ?></a></li>
                     <?php } ?>
                     <?php if($this->permission1->method('create_product','create')->access()){ ?>
                    <li  class="treeview <?php
            if ($this->uri->segment('1') == ("PTLproduct") && $this->uri->segment('2') == ("")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>"><a href="<?php echo base_url('PTLproduct') ?>"><?php echo display('add_product') ?></a></li>
                     <?php }?>
            ...
            ?>"><a href="<?php echo base_url('PTLproduct/add_product_csv') ?>"><?php echo display('import_product_csv') ?></a></li>
                    <?php }?>
            ...
            ?>"><a href="<?php echo base_url('PTLproduct/manage_product') ?>"><?php echo display('manage_product') ?></a></li>
                    <?php }?>
                </ul>
            </li>
        <?php }?>
...
<?php if($this->permission1->method('add_supplier','create')->access() || $this->permission1->method('manage_supplier','read')->access() || $this->permission1->method('supplier_ledger_report','read')->access() || $this->permission1->method('supplier_sales_details_all','read')->access()){?>
            <!-- Supplier menu start -->
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLsupplier")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php
            if ($this->uri->segment('1') == "PTLsupplier" && $this->uri->segment('2') == "") {
                echo "active";
            } else {
                echo " ";
            }
            ?>"><a href="<?php echo base_url('PTLsupplier') ?>"><?php echo display('add_supplier') ?></a></li>
                <?php }?>
            ...
            ?>"><a href="<?php echo base_url('PTLsupplier/manage_supplier') ?>"><?php echo display('manage_supplier') ?></a></li>
                    <?php } ?>
            ...
            ?>"><a href="<?php echo base_url('PTLsupplier/supplier_ledger_report') ?>"><?php echo display('supplier_ledger') ?></a></li>
                     <?php } ?>
                ...
                <li class="treeview <?php if ($this->uri->segment('2') == ("supplier_advance")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLsupplier/supplier_advance') ?>"><?php echo display('supplier_advance') ?></a></li>
                  <?php } ?>
                </ul>
            </li>
        <?php } ?>
            ...
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLpurchase")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                ...
                <ul class="treeview-menu">
                     <?php if($this->permission1->method('add_purchase','create')->access()){ ?>
                    <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLpurchase") && $this->uri->segment('2') == ("")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>"><a href="<?php echo base_url('PTLpurchase') ?>"><?php echo display('add_purchase') ?></a></li>
                       <?php } ?>
            ...
            ?>"><a href="<?php echo base_url('PTLpurchase/manage_purchase') ?>"><?php echo display('manage_purchase') ?></a></li>
                       <?php } ?>
                </ul>
            </li>
        <?php } ?>
         ...
         <?php if($this->permission1->method('add_quotation','create')->access() || $this->permission1->method('manage_quotation','read')->access()){?>
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLquotation")) {
                echo "active";
            } else {
                echo " ";
            }
            ...
            <?php if($this->permission1->method('add_quotation','create')->access()){ ?>
                    <li><a href="<?php echo base_url('PTLquotation') ?>"><?php echo display('add_quotation') ?></a></li>
                <?php }?>
                <?php if($this->permission1->method('manage_quotation','read')->access()){ ?>
                    <li><a href="<?php echo base_url('PTLquotation/manage_quotation') ?>"><?php echo display('manage_quotation') ?></a></li>
                <?php } ?>
                </ul>
            </li>
        <?php }?>
        ...
        <li class="treeview <?php
        if ($this->uri->segment('1') == ("PTLreport")) {
            echo "active";
        } else {
            echo " ";
        }
        ?>">
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == ("PTLreport") && $this->uri->segment('2') == ("")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLreport') ?>"><?php echo display('stock_report') ?></a></li>
            <?php }?>
    ...
    <?php }?>
        ...
        <?php if($this->permission1->method('add_return','create')->access() || $this->permission1->method('return_list','read')->access() || $this->permission1->method('supplier_return_list','read')->access() || $this->permission1->method('wastage_return_list','read')->access()){?>
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLretrun_m")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php if ($this->uri->segment('1') == ("PTLretrun_m") && $this->uri->segment('2') == ("")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLretrun_m') ?>"><?php echo display('return'); ?></a></li>
                      <?php } ?>
                    ...
                    <li class="treeview <?php if ($this->uri->segment('2') == ("return_list")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLretrun_m/return_list') ?>"><?php echo display('stock_return_list') ?></a></li>
                      <?php } ?>
                    ...
                    <li class="treeview <?php if ($this->uri->segment('2') == ("supplier_return_list")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLretrun_m/supplier_return_list') ?>"><?php echo display('supplier_return_list') ?></a></li>
                      <?php } ?>
                    ...
                    <li class="treeview <?php if ($this->uri->segment('2') == ("wastage_return_list")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLretrun_m/wastage_return_list') ?>"><?php echo display('wastage_return_list') ?></a></li>
                      <?php } ?>
...
<!-- New Account End -->
            ...
            ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php if ($this->uri->segment('1') == ("PTLsettings") && $this->uri->segment('2') == ("index")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLsettings/index') ?>"><?php echo display('add_new_bank') ?></a></li>
                <?php }?>
                  ...
                  <?php if($this->permission1->method('bank_list','read')->access()){ ?>
                    <li class="treeview <?php if ($this->uri->segment('2') == ("bank_list")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLsettings/bank_list') ?>"><?php echo display('manage_bank') ?></a></li>
                <?php }?>
                  <?php if($this->permission1->method('bank_transaction','create')->access()){ ?>
                    <li class="treeview <?php if ($this->uri->segment('2') == ("bank_transaction")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLsettings/bank_transaction') ?>"><?php echo display('bank_transaction') ?></a></li>
                <?php }?>
                  ...
                  <?php if($this->permission1->method('bank_ledger','read')->access()){ ?>
                    <li class="treeview <?php if ($this->uri->segment('2') == ("bank_ledger")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLsettings/bank_ledger') ?>"><?php echo display('bank_ledger') ?></a></li>
                <?php }?>
                </ul>
            </li>
        <?php } ?>
            ...
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLaccounts") || $this->uri->segment('1') == ("Account_Controller") || $this->uri->segment('1') == ("Cpayment")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
             ...
             <?php if($this->permission1->method('tax_settings','create')->access()){ ?>       
                <li class="treeview <?php if ($this->uri->segment('2') == ("tax_settings")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLaccounts/tax_settings') ?>"><?php echo display('tax_settings') ?></a></li>
                      <?php } ?>
                ...
                <?php if($this->permission1->method('add_incometax','create')->access()){ ?>
                 <li class="treeview <?php if ($this->uri->segment('2') == ("add_incometax")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLaccounts/add_incometax') ?>"><?php echo display('add_incometax') ?></a></li>
                 <?php } ?>
                 <?php if($this->permission1->method('manage_income_tax','read')->access()){ ?>
                  <li class="treeview <?php if ($this->uri->segment('2') == ("manage_income_tax")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLaccounts/manage_income_tax') ?>"><?php echo display('manage_income_tax') ?></a></li>
                    <?php } ?>
                <?php if($this->permission1->method('tax_report','read')->access()){ ?>    
                    <li class="treeview <?php if ($this->uri->segment('2') == ("tax_report")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLaccounts/tax_report') ?>"><?php echo display('tax_report') ?></a></li>
                    <?php } ?>
                ...
                <li class="treeview <?php if ($this->uri->segment('2') == ("invoice_wise_tax_report")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLaccounts/invoice_wise_tax_report') ?>"><?php echo display('invoice_wise_tax_report') ?></a></li>
                <?php } ?>
                     </ul>
       ...
       <?php } ?>
            ...
            <!-- Supplier menu start -->
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLhrm") || $this->uri->segment('1') == ("PTLattendance") || $this->uri->segment('1') == ("PTLpayroll") || $this->uri->segment('1') == ("PTLexpense") || $this->uri->segment('1') == ("PTLloan") || $this->uri->segment('2') == ("add_person") || $this->uri->segment('2') == ("add_loan") || $this->uri->segment('2') == ("add_payment") || $this->uri->segment('2') == ("manage_person") || $this->uri->segment('2') == ("person_loan_edit")) {
                echo "active";
            } else {
                echo " ";
            }
       ...
       <?php if($this->permission1->method('add_designation','create')->access() || $this->permission1->method('manage_designation','read')->access() || $this->permission1->method('add_employee','create')->access() || $this->permission1->method('manage_employee','read')->access()){?>
         ...
         <?php if($this->permission1->method('add_designation','create')->access()){ ?>          
          <li class="treeview <?php if ($this->uri->segment('2') == ("add_designation")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLhrm/add_designation') ?>"><?php echo display('add_designation') ?></a></li>
     <?php } ?>
         <?php if($this->permission1->method('manage_designation','read')->access()){ ?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLhrm/manage_designation') ?>"><?php echo display('manage_designation') ?></a></li>
                          <?php } ?>
        <?php if($this->permission1->method('add_employee','create')->access()){ ?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLhrm/add_employee') ?>"><?php echo display('add_employee') ?></a></li>
                    <?php } ?>
            <?php if($this->permission1->method('manage_employee','read')->access()){ ?>        
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLhrm/manage_employee') ?>"><?php echo display('manage_employee') ?></a></li> 
                          <?php } ?> 
        ...
        <?php } ?>
            ...
            <?php if($this->permission1->method('add_attendance','create')->access() || $this->permission1->method('manage_attendance','read')->access() || $this->permission1->method('attendance_report','read')->access()){?>
                          <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLattendance")) {
                echo "active";
            } else {
                echo " ";
            }
         ...
         <?php if($this->permission1->method('add_attendance','create')->access()){ ?>       
               <li class="treeview <?php if ($this->uri->segment('2') == ("add_attendance")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLattendance/add_attendance') ?>"><?php echo display('add_attendance') ?></a></li>
           <?php } ?>
        <?php if($this->permission1->method('manage_attendance','read')->access()){ ?>   
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLattendance/manage_attendance') ?>"><?php echo display('manage_attendance') ?></a></li> 
                          <?php } ?>
        <?php if($this->permission1->method('attendance_report','read')->access()){ ?>  
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLattendance/attendance_report') ?>"><?php echo display('attendance_report') ?></a></li> 
                          <?php } ?>
                </ul>
            </li>
              <?php } ?>
            ...
            <!-- Supplier menu start -->
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLpayroll")) {
                echo "active";
            } else {
                echo " ";
            }
            ...
            <?php if($this->permission1->method('add_benefits','create')->access()){ ?>
                      <li class="treeview <?php if ($this->uri->segment('2') == ("Salarybenificial")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLpayroll/Salarybenificial') ?>">
            ...
            <?php if($this->permission1->method('manage_benefits','read')->access()){ ?>            
                      <li class="treeview <?php if ($this->uri->segment('2') == ("manage_benefits")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLpayroll/manage_benefits') ?>"><?php echo display('manage_benefits') ?></a></li>
                      <?php }?>
             <?php if($this->permission1->method('add_salary_setup','create')->access()){ ?>          
                      <li class="treeview <?php if ($this->uri->segment('2') == ("salary_setup_form")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLpayroll/salary_setup_form') ?>"><?php echo display('add_salary_setup') ?></a></li>
                       <?php }?>
            <?php if($this->permission1->method('manage_salary_setup','read')->access()){ ?> 
                      <li class="treeview <?php if ($this->uri->segment('2') == ("manage_salary_setup")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLpayroll/manage_salary_setup') ?>"><?php echo display('manage_salary_setup') ?></a></li> 
                       <?php }?> 
            <?php if($this->permission1->method('salary_generate','create')->access()){ ?>            
                       <li class="treeview <?php if ($this->uri->segment('2') == ("salary_generate_form")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLpayroll/salary_generate_form') ?>"><?php echo display('salary_generate') ?></a></li>
                       <?php }?> 
            <?php if($this->permission1->method('manage_salary_generate','read')->access()){ ?>
                       <li class="treeview <?php if ($this->uri->segment('2') == ("manage_salary_generate")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLpayroll/manage_salary_generate') ?>"><?php echo display('manage_salary_generate') ?></a></li>
                        <?php }?> 
                     ...
                     <li class="treeview <?php if ($this->uri->segment('2') == ("salary_payment")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLpayroll/salary_payment') ?>"><?php echo display('salary_payment') ?></a></li>   <?php }?> 
        ...
        <?php } ?>
         ...
         <?php if($this->permission1->method('add_expense_item','create')->access() || $this->permission1->method('manage_expense_item','read')->access() || $this->permission1->method('add_expense','create')->access() || $this->permission1->method('manage_expense','read')->access()){?>
             <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLexpense")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php  if ($this->uri->segment('2') == ("add_expense_item")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLexpense/add_expense_item') ?>"><?php echo display('add_expense_item') ?></a></li>
                <?php }?>
                <?php if($this->permission1->method('manage_expense_item','read')->access()){ ?>
                    <li class="treeview <?php  if ($this->uri->segment('2') == ("manage_expense_item")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLexpense/manage_expense_item') ?>"><?php echo display('manage_expense_item') ?></a></li>
                <?php }?>
                    ...
                    <li class="treeview <?php  if ($this->uri->segment('2') == ("add_expense")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLexpense/add_expense') ?>"><?php echo display('add_expense') ?></a></li>
                <?php } ?>
                <?php if($this->permission1->method('manage_expense','read')->access()){ ?>
                     <li class="treeview <?php  if ($this->uri->segment('2') == ("manage_expense")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLexpense/manage_expense') ?>"><?php echo display('manage_expense') ?></a></li>
                     <?php } ?>
                      ...
                      <li  class="treeview <?php  if ($this->uri->segment('2') == ("expense_statement_form")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLexpense/expense_statement_form') ?>"><?php echo display('expense_statement') ?></a></li>
                  <?php }?>
                </ul>
            </li>
        <?php }?>
    <!-- ========================== Expense menu end ========================== -->
           ...
           <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLloan") && $this->uri->segment('2') == ("add_ofloan_person") || $this->uri->segment('2') == ("manage_ofln_person") || $this->uri->segment('2') == ("person_ledger") || $this->uri->segment('2') == ("add_office_loan") || $this->uri->segment('2') == ("add_loan_payment") || $this->uri->segment('2') == ("person_edit")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php if ($this->uri->segment('2') == ("add_ofloan_person")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLloan/add_ofloan_person') ?>"><?php echo display('add_person') ?></a></li>
                <?php }?>
                 <?php if($this->permission1->method('add_office_loan','create')->access()){ ?>
                      <li class="treeview <?php if ($this->uri->segment('2') == ("add_office_loan")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLloan/add_office_loan') ?>"><?php echo display('add_loan') ?></a></li>
                  <?php }?>
                   <?php if($this->permission1->method('add_loan_payment','create')->access()){ ?>
                    <li class="treeview <?php if ($this->uri->segment('2') == ("add_loan_payment")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLloan/add_loan_payment') ?>"><?php echo display('add_payment') ?></a></li>
                <?php }?>
                 <?php if($this->permission1->method('manage_ofln_person','read')->access()){ ?>
                    <li class="treeview <?php if ($this->uri->segment('2') == ("manage_ofln_person")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLloan/manage_ofln_person') ?>"><?php echo display('manage_person') ?></a></li>
                <?php }?>
                </ul>
            </li> 
        <?php }?>
            ...
            ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php if ($this->uri->segment('2') == ("add_person")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLsettings/add_person') ?>"><?php echo display('add_person') ?></a></li>
                <?php }?>
                <?php if($this->permission1->method('add_loan','create')->access()){ ?>
                    <li class="treeview <?php if ($this->uri->segment('2') == ("add_loan")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLsettings/add_loan') ?>"><?php echo display('add_loan') ?></a></li>
                <?php }?>
                  <?php if($this->permission1->method('add_payment','create')->access()){ ?>
                    <li class="treeview <?php if ($this->uri->segment('2') == ("add_payment")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLsettings/add_payment') ?>"><?php echo display('add_payment') ?></a></li>
                <?php }?>
                 <?php if($this->permission1->method('manage_person','read')->access()){ ?>
                    <li class="treeview <?php if ($this->uri->segment('2') == ("manage_person")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLsettings/manage_person') ?>"><?php echo display('manage_loan') ?></a></li>
                    <?php }?>
                </ul>
            </li>
        <?php }?>
        ...
        <?php } ?>
            ...
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLservice")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php
            if ($this->uri->segment('1') == ("PTLservice") && $this->uri->segment('2') == ("")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>"><a href="<?php echo base_url('PTLservice') ?>"><?php echo display('add_service') ?></a></li>
                <?php } ?>
            ...
            ?>"><a href="<?php echo base_url('PTLservice/manage_service') ?>"><?php echo display('manage_service') ?></a></li>
                      <?php } ?>
            ...
            ?>"><a href="<?php echo base_url('PTLservice/service_invoice_form') ?>"><?php echo display('service_invoice') ?></a></li>
                       <?php } ?>
            ...
            ?>"><a href="<?php echo base_url('PTLservice/manage_service_invoice') ?>"><?php echo display('manage_service_invoice') ?></a></li>
                       <?php } ?>
                </ul>
            </li>
        <?php } ?>
            ...
            ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php if ($this->uri->segment('2') == ("commission")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLsettings/commission') ?>"><?php echo display('generate_commission') ?></a></li>
                      <?php } ?>
                </ul>
            </li>
        <?php } ?>
            ...
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("Company_setup") || $this->uri->segment('1') == ("User") || $this->uri->segment('1') == ("PTLweb_setting") || $this->uri->segment('1') == ("Language") || $this->uri->segment('1') == ("Currency") || $this->uri->segment('1') == ("Permission")|| $this->uri->segment('1') == ("PTLsms") || $this->uri->segment('1') == ("Backup_restore")) {
                echo "active";
            } else {
                echo " ";
            }
            ...
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("Company_setup") || $this->uri->segment('1') == ("User") || $this->uri->segment('1') == ("PTLweb_setting") || $this->uri->segment('1') == ("Language") || $this->uri->segment('1') == ("Currency")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                ...
                <?php if($this->permission1->method('soft_setting','create')->access() || $this->permission1->method('soft_setting','update')->access()){?>
                    <li class="treeview <?php if ($this->uri->segment('1') == ("PTLweb_setting") && $this->uri->segment('2') == ("")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLweb_setting') ?>"><?php echo display('setting') ?> </a></li>
                <?php }?>

                 <?php if($this->permission1->method('mail_setting','create')->access()){?>
                    <li class="treeview <?php if ($this->uri->segment('1') == ("PTLweb_setting") && $this->uri->segment('2') == ("mail_setting")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLweb_setting/mail_setting') ?>"><?php echo display('mail_setting') ?> </a></li>
                <?php }?>
                </ul>
            </li>
        <?php }?>
 ...
 <?php if($this->permission1->method('sms_configure','create')->access()){?>
                <!-- sms menu start -->
                 <li class="treeview <?php if ($this->uri->segment('1') == ("PTLsms")) { echo "active";}else{ echo " ";}?>">
                <a href="#">
                ...
                <ul class="treeview-menu">
                      ...
                      <li class="treeview <?php if ($this->uri->segment('2') == ("configure")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('PTLsms/configure')?>"><?php echo display('sms_configure'); ?></a></li>
