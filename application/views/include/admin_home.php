...
?>
        ...
        <div class="row">
            ...
            <a href="<?php echo base_url('PTLcustomer/manage_customer') ?>" class="small-box-footer"><?php echo display('total_customer')?></a>
          </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            ...
            <a href="<?php echo base_url('PTLproduct/manage_product') ?>" class="small-box-footer"><?php echo display('total_product')?></a>
          </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
         <div class="small-box bg-bringal whitecolor">
            ...
            <a href="<?php echo base_url('PTLsupplier/manage_supplier') ?>" class="small-box-footer"><?php echo display('total_supplier')?> </a>
          </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            ...
            <a href="<?php echo base_url('PTLinvoice/manage_invoice') ?>" class="small-box-footer"><?php echo display('total_invoice')?> </a>
          </div>
            </div>
        </div>
        <hr>
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="panel panel-bd">
                     ...
                     foreach ($todays_sales_report as $single) {
                      $sql =$this->Reports->dashboard_query1($single->invoice_id,$single->customer_id); 
                      $result = $this->db->query($sql)->row();
                                                ...
                                                <tr>
                                                    <td><?php echo $sl; ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>PTLcustomer/customerledger/<?php echo $single->customer_id; ?>">
                                                            <?php echo html_escape($single->customer_name); ?>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo base_url() . 'PTLinvoice/invoice_inserted_data/'; ?><?php echo html_escape($single->invoice_id); ?>">
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        echo html_escape(number_format($result->total_amount - $result->total_discount, '2','.',',')); 
                                                        ?>
                                                    </td>
                                                    <td class="text-right">
                                                        <?php
                                                        $ttl_paid += $result->total_paid;
                                                        echo html_escape(number_format($result->total_paid, '2', '.', ',')); ?>
                                                    </td>
