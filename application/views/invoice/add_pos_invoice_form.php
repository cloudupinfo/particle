...
<div class="content-wrapper">
    ...
    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span>
       ...
       <?php if($this->permission1->method('new_invoice','create')->access()){ ?>
                    <a href="<?php echo base_url('PTLinvoice') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('new_invoice') ?> </a>
                <?php }?>
<?php if($this->permission1->method('manage_invoice','read')->access()){ ?>
                    <a href="<?php echo base_url('PTLinvoice/manage_invoice') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('manage_invoice') ?> </a>
 <?php }?>
...
<br>
                    <div class="panel-body">
                        ...
                        <?php echo form_open_multipart('PTLinvoice/manual_sales_insert', array('class' => 'form-vertical', 'id' => 'pos_sale_insert', 'name' => 'insert_pos_invoice')) ?>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
      ...
      <div class="modal-dialog modal-sm">
        ...
        <a href="" class="close" data-dismiss="modal" aria-hidden="true">&times;</a>
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="url" value="<?php echo base_url('PTLinvoice/pos_invoice');?>">
          </div>
