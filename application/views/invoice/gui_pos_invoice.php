...
<div class="content-wrapper">
 ...
 <div class="col-sm-12">
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="nsale">
                ...
                <div class="panel panel-default">
                    <div class="panel-body"> 
                         <input name="url" type="hidden" id="posurl" value="<?php echo base_url("PTLinvoice/getitemlist") ?>" />
                        <div class="col-sm-6">
 ...
 <div class="form-group">
   <?php echo form_open_multipart('PTLinvoice/manual_sales_insert', array('class' => 'form-vertical', 'id' => 'gui_sale_insert', 'name' => 'insert_pos_invoice')) ?>
                                ...
                                <tbody>
                                    ...
                                    if ($todays_invoice) {
                                        ...
                                        <tr>
                                            <td><?php echo $sl ; ?></td>
                                            <td>
                                                <a href="<?php echo base_url() . 'PTLinvoice/invoice_inserted_data/'.$invoices_list['invoice_id']; ?>">
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() . 'PTLcustomer/customerledger/'.$invoices_list['invoice_id']; ?>"><?php echo html_escape($invoices_list['customer_name'])?></a>             
                                            </td>
                                    ...
                                    <center>
                                        ...
                                        <a href="<?php echo base_url() . 'PTLinvoice/invoice_inserted_data/'.$invoices_list['invoice_id']; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('invoice') ?>"><i class="fa fa-window-restore" aria-hidden="true"></i></a>
                                    <a href="<?php echo base_url() . 'PTLinvoice/min_invoice_inserted_data/'.$invoices_list['invoice_id']; ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo 'Mini Invoice' ?>"><i class="fa fa-fax" aria-hidden="true"></i></a>

                                        <a href="<?php echo base_url() . 'PTLinvoice/pos_invoice_inserted_data/'.$invoices_list['invoice_id']; ?>" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('pos_invoice') ?>"><i class="fa fa-fax" aria-hidden="true"></i></a>
                                        <?php if($this->permission1->method('manage_invoice','update')->access()){ ?>

                                        <a href="<?php echo base_url() . 'PTLinvoice/invoice_update_form/'.$invoices_list['invoice_id']; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <?php }?>
    ...
    <div class="modal fade modal-success" id="cust_info" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                       ...
                       <?php echo form_open('PTLinvoice/instant_customer', array('class' => 'form-vertical', 'id' => 'newcustomer')) ?>
                    <div class="panel-body">
 <input type ="hidden" name="csrf_test_name" id="" value="<?php echo $this->security->get_csrf_hash();?>">
                        <div class="form-group row">
   ...
   <div class="row">
      ...
      <div class="modal-dialog modal-sm">
        ...
        <a href="" class="close" data-dismiss="modal" aria-hidden="true">&times;</a>
          ...
          <div class="modal-body">
            <?php echo form_open('PTLinvoice/pos_invoice_inserted_data_manual', array('class' => 'form-vertical', 'id' => '', 'name' => '')) ?>
            ...
            <input type="hidden" name="url" value="<?php echo base_url('PTLinvoice/gui_pos');?>">
          </div>
          <div class="modal-footer">
