...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small><?php echo display('benefits_list') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('payroll') ?></a></li>
                <li class="active"><?php echo display('benefits_list') ?></li>
            </ol>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
         ...
         <?php if($this->permission1->method('manage_benefits','update')->access()){ ?>                          
                                        <a href="<?php echo base_url("PTLpayroll/benefits_update_form/$que->salary_type_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> 
                                    <?php }?>
     <?php if($this->permission1->method('manage_benefits','delete')->access()){ ?>                             
                                        <a href="<?php echo base_url("PTLpayroll/delete_benefits/$que->salary_type_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
                                       <?php }?>
                                    </td>
                                </tr>
                                <?php $sl++; ?>
