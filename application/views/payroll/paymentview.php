                                    ...
                                    <td><?php echo html_escape($que->paid_by); ?></td>
                                       ...
                                       <?php 
                                        if($que->payment_due =='paid'){?>
                                            <a href='<?php echo base_url("PTLpayroll/payslip/$que->emp_sal_pay_id") ?>' class='btn btn-info btn-xs'><?php echo display('payslip') ?></a>       
                                       <?php } 
                                        else {?>
   ...
   <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-bd">
                ...
                <?php echo  form_open('PTLpayroll/payconfirm/') ?>
