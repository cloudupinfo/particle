...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <?php if($this->permission1->method('manage_salary_generate','delete')->access()){ ?>
                                        <a href="<?php echo base_url("PTLpayroll/delete_salgenerate/$que->ssg_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
                                    <?php } ?>
