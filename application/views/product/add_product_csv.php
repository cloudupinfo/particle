    ...
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url('PTLproduct')?>"><?php echo display('product') ?></a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                   ...
                   <?php if($this->permission1->method('create_product','create')->access()){ ?>
                    <a href="<?php echo base_url('PTLproduct')?>" class="btn btn-warning m-b-5 m-r-2"><i class="ti-align-plus"></i>  <?php echo display('add_product')?></a>
                   <?php }?>
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                     ...
                     <?php echo form_open_multipart('PTLproduct/uploadCsv',array('class' => 'form-vertical', 'id' => 'validate','name' => 'insert_product'))?>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-6">
