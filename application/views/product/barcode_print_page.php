        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('PTLproduct/insert_product') ?>
                    <div class="panel-body">
                        ...
                        if (!empty($product_id) || !empty($qr_image)) {
                            ...
                            <div class="text-center">
                                ...
                                <a  class="btn btn-danger" href="<?php echo base_url('PTLproduct'); ?>"><?php echo display('cancel') ?></a>
                            </div>
                            <?php
                        }
                        ?>
                                            ...
                                            <?php if ($counter == $cqty) { ?>
                                                ...
                                                <td class="barcode-toptd">      
                                                    ...
                                                    <div class="barcode-inner barcode-innerdiv">
                                                        ...
                                                        <img src="<?php echo base_url('PTLbarcode/barcode_generator/{product_id}') ?>" class="img-responsive center-block barcode-image" alt="" >
