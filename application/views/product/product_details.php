    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <a href="<?php echo base_url('PTLproduct') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_product') ?> </a>

                    <a href="<?php echo base_url('PTLproduct/add_product_csv') ?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_product_csv') ?> </a>

                    <a href="<?php echo base_url('PTLproduct/manage_product') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('manage_product') ?> </a>
                                ...
                                <tbody>
                                    ...
                                    if ($purchaseData) {
                                        ...
                                        <tr>
                                            <td>{final_date}</td>
                                            <td>
                                                <a href="<?php echo base_url() . 'PTLpurchase/purchase_details_data/{purchase_id}'; ?>">
                                                    {chalan_no}
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() . 'PTLsupplier/supplier_ledger_info/{supplier_id}'; ?>">{supplier_name}</a>
                                            </td>
                                ...
                                <tbody>
                                    ...
                                    if ($salesData) {
                                        ...
                                        <tr>
                                            <td>{final_date}</td>
                                            <td>
                                                <a href="<?php echo base_url() . 'PTLinvoice/invoice_inserted_data/{invoice_id}'; ?>">
                                                    {invoice_id}
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() . 'PTLcustomer/customer_ledger_report'; ?>">{customer_name}</a>
                                            </td>
                                            <td  class="text-right;">{quantity}</td>
                                            <td  class="text-right;"> <?php echo (($position == 0) ? "$currency {rate}" : "{rate} $currency") ?></td>
