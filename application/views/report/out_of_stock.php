		...
		<div class="row">
            <div class="col-sm-12">
                  ...
                  <?php if($this->permission1->method('stock_report','read')->access()){ ?>
                    <a href="<?php echo base_url('PTLreport') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('stock_report') ?> </a>
                <?php }?>
								 ...
								 ?>
									<tr>
										...
										<td class="text-center">
											<a href="<?php echo base_url().'PTLproduct/product_details/'.$out_of_stock['product_id']; ?>">
