...
<div class="content-wrapper">
    ...
    <?php if($this->permission1->method('stock_report_pro_wise','read')->access()){ ?>
                    <a href="<?php echo base_url('PTLreport/stock_report_product_wise') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('stock_report_product_wise') ?> </a>
                    <?php }?>
      <?php if($this->permission1->method('stock_report','read')->access()){ ?>
                    <a href="<?php echo base_url('PTLreport') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('stock_report') ?> </a>
                      <?php }?>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        ...
                        <?php echo form_open('PTLreport/stock_report_supplier_wise', array('class' => 'form-vertical', 'id' => 'stock_report_supplier_wise')); ?>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo display('stock') ?>
                                             ...
                                             <th class="text-center"><?php echo display('stock_sale') ?>
                                                  <?php echo form_open('PTLreport/stock_report_supplier_wise', array('class' => 'form-inline', 'method' => 'post')) ?>
                                        ...
                                        if ($stok_report) {
                                            ...
                                            foreach ($stok_report as $stok_report) {
                                                ...
                                                <tr>
                                                    <td><?php echo $sl; ?></td>
                                                    <td align="center">
                                                        <a href="<?php echo base_url() . 'PTLproduct/product_details/' . $stok_report['product_id']; ?>">

                                                            <?php echo $stok_report['product_name']; ?>
                                                        </a>        
                                                    </td>
                                                    <td align="center"><a href="<?php echo base_url() . 'PTLproduct/product_details/' . $stok_report['product_id']; ?>"><?php echo $stok_report['product_model']; ?></a>  </td>
