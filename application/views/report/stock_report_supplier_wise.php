...
<div class="content-wrapper">
    ...
    <section class="content">
     ...
     <?php if($this->permission1->method('stock_report_sp_wise','read')->access()){ ?>
                    <a href="<?php echo base_url('PTLreport/stock_report_supplier_wise') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('stock_report_supplier_wise') ?> </a>
                   <?php }?>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo display('stock') ?>
                                             ...
                                             <th class="text-center"><?php echo display('stock_sale') ?>
                                                 <?php echo form_open('PTLreport/stock_report_product_wise', array('class' => 'form-inline', 'method' => 'post')) ?>
