 ...
 <div class="row">
            <div class="col-sm-12">
                 ...
                 <?php if($this->permission1->method('return_list','read')->access()){ ?>
                  <a href="<?php echo base_url('PTLretrun_m/return_list')?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('customer_return_list')?> </a>
              <?php }?>
               <?php if($this->permission1->method('supplier_return_list','read')->access()){ ?>
                    <a href="<?php echo base_url('PTLretrun_m/supplier_return_list')?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('supplier_return')?> </a>
                      <?php }?>
                      <?php if($this->permission1->method('wastage_return_list','read')->access()){ ?>
                      <a href="<?php echo base_url('PTLretrun_m/wastage_return_list')?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('wastage_list')?> </a>
                      <?php }?>
            ...
            <div class="col-sm-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body"> 
                        <?php echo form_open('PTLretrun_m/invoice_return_form',array('class' => 'form-inline'))?>
            ...
            <div class="col-sm-6">
                <div class="panel panel-default">
                     <div class="panel-heading">
                      ...
                      <div class="panel-body"> 
                        <?php echo form_open('PTLretrun_m/supplier_return_form',array('class' => 'form-inline'))?>
