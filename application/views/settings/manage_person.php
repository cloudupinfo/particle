    ...
    <section class="content">
        ...
        <div class="row">
          ...
          <?php if($this->permission1->method('add1_person','create')->access()){ ?>
                    <a href="<?php echo base_url('PTLloan/add_ofloan_person') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_person') ?> </a>
                <?php }?>
                            ...
                            <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <?php echo form_open('PTLloan/manage1_person', array('class' => 'form-inline', 'method' => 'post')) ?>
                                ...
                                <tbody>
                                    ...
                                    if ($person_list) {
                                        ...
                                        foreach ($person_list as $person) {
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="<?php echo base_url('PTLsettings/person_ledger/' . $person['person_id']); ?>">
                                                ...
                                                <?php if($this->permission1->method('manage1_person','read')->access()){ ?>
                                                    <a href="<?php echo base_url('PTLsettings/person_edit/' . $person['person_id']); ?>"class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="Update">
                                                        <i class="fa fa-pencil" aria-hidden="true"></i>
                                                    </a>
                                                <?php }?>
                                                  <?php if($this->permission1->method('manage1_person','delete')->access()){ ?>
                                                  <a href="<?php echo base_url('PTLsettings/delete_office_loan/'.$person['person_id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a>
                                                  <?php }
                                        ?>
                                                </td>
                                            </tr>
