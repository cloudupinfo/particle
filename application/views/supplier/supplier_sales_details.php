	...
	<section class="content">
		...
		<div class="row">
            <div class="col-sm-12">
                  ...
                  <a href="<?php echo base_url('PTLsupplier')?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_supplier')?> </a>

                  <a href="<?php echo base_url('PTLsupplier/manage_supplier')?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('manage_supplier')?> </a>

                  <a href="<?php echo base_url('PTLsupplier/supplier_ledger_report')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('supplier_ledger')?> </a>
              ...
              <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        ...
                        <?php echo form_open('PTLsupplier/supplier_sales_details_datewise', array('class' => 'form-inline', 'method' => 'get')) ?>
                        <?php
			                    ...
			                    <table class="table table-bordered table-striped table-hover">
									...
									{sales_info}
										<tr>
											...
											<td>{date}</td>
											<td>
												<a href="<?php echo base_url().'PTLproduct/product_details/{product_id}'; ?>">
													{product_name} - {product_model}
												</a>
											</td>
											<td align="right">{supplier_name}</td>
											<td align="center"><a href="<?php echo base_url().'PTLinvoice/invoice_inserted_data/{invoice_id}'; ?>">{invoice}</a></td>
