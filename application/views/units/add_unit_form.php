...
<div class="tab-content">
  ...
  <div id="unitLists" class="tab-pane fade in active">
    <div class="row cat-tabcontent">
         <div class="table-responsive">
             ...
             <?php if($this->permission1->method('manage_unit','update')->access()){ ?>
                                        <a href="<?php echo base_url() . 'PTLunit/unit_update_form/{unit_id}'; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <?php }?>
              <?php if($this->permission1->method('manage_unit','delete')->access()){ ?>
                                        <a href="<?php echo base_url() . 'PTLunit/unit_delete/{unit_id}'; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Want To Delete ?')" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                         <?php }?>
                                            <?php echo form_close() ?>
                                    </center>
                                    </td>
    ...
    <div id="add_unit" class="tab-pane fade">
         <div class="row cat-tabcontent">
     <?php echo form_open('PTLunit/insert_unit', array('class' => 'form-vertical', 'id' => 'insert_unit')) ?>
  ...
  <div id="csvupload" class="tab-pane fade">
    ...
    <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <?php echo form_open_multipart('PTLunit/uploadCsv_unit',array('class' => 'form-vertical', 'id' => 'validate','name' => 'insert_category'))?>
                            <div class="col-sm-12">
                                <div class="form-group row">
