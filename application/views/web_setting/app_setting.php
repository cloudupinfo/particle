            ...
            <tr><td> <img src="<?php echo base_url('my-assets/image/qr/{qr_image}') ?>" class="img-responsive center-block appsettingqr" alt="">
                ...
                <td> <img src="<?php echo base_url('my-assets/image/qr/{hotspotqrimg}') ?>" class="img-responsive center-block appsettingqr" alt=""><span class="appsettingqrtxt">Hotspot Ip/Url QR Code</span>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-8">
                           <?php echo form_open_multipart('PTLweb_setting/update_app_setting', array('class' => 'form-vertical', 'id' => 'app_settings')) ?>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <span  class="text-danger">http://xyz.com/saleserp</span>
                            </div>
                        </div>
                         <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <span  class="text-danger">http://xxx.xxx.x.xxx/saleserp</span>
                            </div>
                        </div>
