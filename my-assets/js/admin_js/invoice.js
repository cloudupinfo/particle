...
function stockLimit(t) {
    ...
    $.ajax({
        type: "POST",
        url: o + "PTLinvoice/product_stock_check",
        data: {
            product_id: e
        },
        cache: !1,
...
var count = 2,
   ...
   var base_url = $("#base_url").val();
        $.ajax({
            url: base_url + 'PTLinvoice/previous',
            type: 'post',
    ...
    var options = {
        ...
        $.ajax( {
          url: base_url + "PTLinvoice/customer_autocomplete",
          method: 'post',
          dataType: "json",
          data: {
            term: request.term,
...
$(document).ready(function(){
 ...
 var priceClass = 'price_item'+sl;
    ...
    var options = {
        ...
        $.ajax( {
          url: base_url + "PTLinvoice/autocompleteproductsearch",
          method: 'post',
          dataType: "json",
          data: {
            term: request.term,
       ...
       select: function( event, ui ) {
            $(this).parent().parent().find(".autocomplete_hidden_value").val(ui.item.value); 
                ...
                $.ajax
                   ({
                        type: "POST",
                        url: base_url+"PTLinvoice/retrieve_product_data_inv",
